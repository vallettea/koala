...
from koala.excel.functions import ( 
    match,
    mod,
    count,
    countif,
...
# WARNING: MULTI DIM RANGES NOT SUPPORTED
class Test_Index(unittest.TestCase):
    ...
    def test_index_out_of_range(self):
        with self.assertRaises(Exception):
            index([[0, 0.2, 0.15], [0, 0.2, 0.2]], 2, 4)

    def test_regular(self):
        self.assertEqual(index([[0, 0.2, 0.15], [0, 0.2, 0.2]], 2, 3), 0.2)
