...
class Test_Spreadsheet(unittest.TestCase):
    ...
    def test_load_filename(self):
        spreadsheet = Spreadsheet.fromfilename("./tests/excel/VDB.xlsx")
    ...
    def test_load_stream(self):
        spreadsheet = Spreadsheet.fromfilename("./tests/excel/VDB.xlsx")
        spreadsheet.gen_graph()
        self.assertEqual(spreadsheet.evaluate('Sheet1!A2'), "Init")


    def test_as_from_dict(self):
        sp1 = Spreadsheet.fromfilename("./tests/excel/VDB.xlsx")
        sp1.gen_graph()
        sp1.set_value('Sheet1!B7', 100)
        sp1.set_value('Sheet1!B8', 200)
        ...
        sp2.set_value('Sheet1!B7', 500)
        sp2.set_value('Sheet1!B8', 600)
