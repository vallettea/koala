...
class Test_Excel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # for cell in self.sp.cellmap.values():
        #     if cell.is_range and cell.range.is_volatile:
        #         print 'Cell', cell.address()
        #         print 'Start', cell.range.reference["start"]
        #         print 'End', cell.range.reference["end"]

        #         count += 1

        # print 'NB VOLATILE ranges', count
    ...
    #     print self.sp.eval_ref("Sheet1!A17:Sheet1!F17").info
    #     for cell in self.sp.cellmap["Sheet1!A17:Sheet1!F17"].range.cells:
    #         print cell.address(), cell.python_expression 
