...
class Test_Excel(unittest.TestCase):
    ...
    def test_get_values_scalar(self):
        range = Range((['A3'], 1, 1), [1])

        self.assertEqual(find_associated_values((3, 'C'), range), (1, None))

    def test_get_values(self):
        range1 = Range((['D4', 'D5', 'D6'], 3, 1), [1, 2, 3])
        range2 = Range((['E4', 'E5', 'E6'], 3, 1), [1, 2, 3])

    	self.assertEqual(find_associated_values((5, 'F'), range1, range2), (2, 2))
    ...
    #     self.assertEqual(Range.apply_one('add', range1, range2, 'C1'), 2) # 1 + 1 = 2

    # def test_add_array_one_constant(self):
    #     range = Range(['A1', 'A2', 'A3'], [1, 2, 3])
    #     constant = 2

    #     self.assertEqual(Range.apply_one('add', range, constant, 'C1'), 3) # 1 + 2 = 3

    # def test_add_all(self):
    #     range1 = Range(['A1', 'A2', 'A3'], [1, 10, 3])
    #     range2 = Range(['B1', 'B2', 'B3'], [3, 3, 1])

    #     self.assertEqual(Range.apply_all('add', range1, range2, 'C2').values(), [4, 13, 4])
    ...
    #     self.assertEqual(Range.apply_one('substract', range1, range2, 'C2'), 7) # 10 - 3 = 7
    ...
    #     self.assertEqual(Range.apply_one('multiply', range1, range2, 'C2'), 30) # 10 * 3 = 30
    ...
    #     self.assertEqual(Range.apply_one('divide', range1, range2, 'C2'), 10) # 30 / 3 = 10
    ...
    #     self.assertEqual(Range.apply_one('is_equal', range1, range2, 'C2'), False) # 30 == 3 is False
    ...
    #     self.assertEqual(Range.apply_one('is_not_equal', range1, range2, 'C2'), True) # 30 != 3 is True
    ...
    #     self.assertEqual(Range.apply_one('is_strictly_superior', range1, range2, 'C2'), True) # 30 > 3 is True
    ...
    #     self.assertEqual(Range.apply_one('is_strictly_inferior', range1, range2, 'C2'), False) # 30 < 3 is False
    ...
    #     self.assertEqual(Range.apply_one('is_superior_or_equal', range1, range2, 'C3'), True) # 3 >= 3 is True
    ...
    #     self.assertEqual(Range.apply_one('is_inferior_or_equal', range1, range2, 'C1'), True) # 1 <= 3 is False
